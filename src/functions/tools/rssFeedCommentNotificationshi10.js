...
const filePath = path.join(`${__dirname}/../../json/processedCommentEntries_hi10.json`);
  ...
  const executeRssFeedCheckCommand = async () => {
    try {
      ...
      for (const embed of embeds) {
        ...
        const channel = await guild.channels.fetch('1260099505555112017').catch(console.error);
