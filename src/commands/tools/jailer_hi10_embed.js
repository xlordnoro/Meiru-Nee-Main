...
//Sends the output of the embed to a different channel and pings the role via their id. Otherwise, print they lack the role required to run the command.
        ...
        const channel = client.channels.cache.get('1196527267149512865');
        channel.send({content: `<@&1196518352919744644>`, allowedMentions: { roles: ['1196518352919744644'] }, embeds: [embed], components: [buttons]});
